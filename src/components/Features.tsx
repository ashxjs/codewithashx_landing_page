const features = [
  ...
  },
  {
    ...
    description:
      "Avec JavaScript, vous pouvez créer des applications web (site vitrine, site e-commerce, etc.), des applications mobiles (pour IOs et Android) et des serveurs (API, etc.)",
  },
];
